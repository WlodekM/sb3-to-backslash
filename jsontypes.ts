...
export type broadcastBlock = [12, string, string]
export type varBlockId = 12 | 13;
export type varBlock = [varBlockId, string, string] | [varBlockId, string, string, ...number[]]
export type jsonBlock = blockBlock | varBlock | broadcastBlock
